...
export default function SettingsMenu({ playbackRate, onChangePlaybackRate }) {
  ...
  const speedLabel = playbackRate === 1 ? '보통' : `${playbackRate}x`;
        ...
        <div className={styles.menu} onClick={(e) => e.stopPropagation()}>
          {panel === 'main' && (
            <>
              ...
              <button className={styles.menuItem} type="button" onClick={() => setPanel('speed')}>
          ...
          {panel === 'speed' && (
            <>
              <button className={styles.backBtn} type="button" onClick={() => setPanel('main')}>
                <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16" aria-hidden="true">
